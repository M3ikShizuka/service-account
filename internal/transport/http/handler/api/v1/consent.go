...
// @Failure     302 {object} object{error=string}
// @Failure     400 {object} object{error=string}
// @Failure     500 {object} object{error=string}
// @Router      /consent [get]
func (h *HandlerAccountManagementAPI) consentGet(context *gin.Context) {
...
// @Failure     500 {object} object{error=string}
// @Router      /consent [post]
func (h *HandlerAccountManagementAPI) consentPost(context *gin.Context) {
...
func (h *HandlerAccountManagementAPI) callback(context *gin.Context) {
